...
python3 experiment_transducer.py --env halfcheetah --dataset medium --seed 3 --device cuda:2 --log_to_wandb True
python3 experiment_transducer.py --env halfcheetah --dataset medium --seed 4 --device cuda:2 --log_to_wandb True
